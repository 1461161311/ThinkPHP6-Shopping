 ...
 * Time: 下午5:42
 */
namespace yunpian_php_sdk\lib;

use yunpian_php_sdk\lib\HttpUtil as HttpUtil2;
...
class SmsOperator
{
    ...
    public function __construct($config,$apikey = null, $api_secret = null)
    {
//        $this->yunpian_config = $GLOBALS['YUNPIAN_CONFIG'];
        $this->yunpian_config = $config;
        if ($api_secret == null)
    ...
    public function single_send($data = array())
    {
        ...
        return HttpUtil2::PostCURL($this->yunpian_config['URI_SEND_SINGLE_SMS'], $data);
    }
