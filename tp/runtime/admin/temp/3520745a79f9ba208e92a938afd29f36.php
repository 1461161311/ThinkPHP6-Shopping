<?php /*a:1:{s:78:"E:\Code\Git-tp6\ThinkPHP6-Shopping_Project\tp\app\admin\view\goods\update.html";i:1611108078;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item layui-show">
                    <form action="" class="layui-form" id="myform" lay-filter="form-filter">
                        <div class="layui-form-item">
                            <div class="layui-input-inline">
                                <input type="hidden" name="id" value="<?php echo htmlentities($goods['id']); ?>" lay-verify="id" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="title" id="goods_name" lay-verify="required"
                                       placeholder="请输入商品名称"
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['title']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="category_id" id="goods_cate" placeholder="<?php echo htmlentities($goods['category_path_name'][0]); ?>-><?php echo htmlentities($goods['category_path_name'][1]); ?>-><?php echo htmlentities($goods['category_path_name'][2]); ?>"
                        ...
                        <div class="layui-form layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="sub_title" id="subtitle" lay-verify="required"
                                       ...
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['sub_title']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="promotion_title" id="goods_sales" lay-verify="required"
                                       ...
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['promotion_title']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="keywords" id="goods_word" placeholder="请输入商品关键词"
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['keywords']); ?>">
                            </div>
                        </div>
                        <div class="layui-form layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="goods_unit" id="goods_unit" placeholder="请输入商品单位"
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['goods_unit']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="is_show_stock" value="1" title="是" <?php if($goods['is_show_stock']== 1): ?>checked="" <?php endif; ?> >
                                <input type="radio" name="is_show_stock" value="0" title="否" <?php if($goods['is_show_stock']== 0): ?>checked="" <?php endif; ?> >
                            </div>
                        </div>
                        <div class="layui-form layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="number" name="stock" id="goods_stock" placeholder="请输入商品总库存 /件"
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['stock']); ?>">
                            </div>
                        </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="production_time" id="goods_date" autocomplete="off"
                                           class="layui-input" value="<?php echo htmlentities($goods['production_time']); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item spec-is-show">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="market_price" id="market_price" placeholder="请输入市场价格 /元"
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['cost_price']); ?>">
                            </div>
                        </div>
                        <div class="layui-form-item spec-is-show">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="sell_price" id="sell_price" placeholder="请输入销售价格 /元"
                                       autocomplete="off" class="layui-input" value="<?php echo htmlentities($goods['price']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-input-inline">
                            <div class="layui-upload">
                                ...
                                <div class="layui-upload-list big_image">
                                    <p id="demoText" ></p>
                                    <div class="img-wrap"><img src="<?php echo htmlentities($goods['big_image']); ?>" class="layui-upload-img upload-img"><i class="layui-icon layui-icon-close btn-del"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="layui-input-block">
                            <div class="layui-upload">
                                ...
                                <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                    预览图：
                                    <div class="layui-upload-list" id="banner_img"></div>
                                    原图：<br/>
                                    <?php if(is_array($carousel_image['image']) || $carousel_image['image'] instanceof \think\Collection || $carousel_image['image'] instanceof \think\Paginator): $i = 0; $__LIST__ = $carousel_image['image'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <div class="img-wrap"><img src="<?php echo htmlentities($vo); ?>"  class="layui-upload-img upload-img"><i class="layui-icon layui-icon-close btn-del"></i></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-upload">
                                <button type="button" class="layui-btn" id="btn_show" value="<?php echo htmlentities($goods['recommend_image']); ?>">图片上传(1M)</button>
                                <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                    预览图：
                                    <div class="layui-upload-list" id="show_img"></div>
                                    原图：<br/>
                                    <div class="img-wrap"><img src="<?php echo htmlentities($goods['recommend_image']); ?>"  class="layui-upload-img upload-img"><i class="layui-icon layui-icon-close btn-del"></i></div>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                       <textarea id="content" style="display: none;"  value="<?php echo htmlentities($goods['description']); ?>"><?php echo htmlentities($goods['description']); ?></textarea>
                    </div>
                </div>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate', 'element'], function () {
        ...
        layui.form.on('submit(*)', function (data) {
            ...
            url = '<?php echo url("goods/saveUpdate"); ?>';
            // 发送ajax请求
