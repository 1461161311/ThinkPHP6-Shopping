<?php /*a:1:{s:78:"E:\Code\Git-tp6\ThinkPHP6-Shopping_Project\tp\app\admin\view\category\add.html";i:1609940098;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <a class="layui-btn layui-btn-danger" href="<?php echo url('index'); ?>">取消添加</a>
        </div>
    </div>
</form>
...
<script>
    layui.use(['form', 'laypage'], function () {
        ...
        function _classif(res = []) {
            // res 分类数据 先期模拟
            let temps = '<option value="0">-| 顶级分类</option>';
