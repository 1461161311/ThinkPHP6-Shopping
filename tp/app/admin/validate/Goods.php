...
class Goods extends Validate
{
    // 需要验证的字段以及规则
    protected $rule = [
        'title' => 'require|max:128',           // 标题
        'category_id' => 'require',     // 分类
        'sub_title' => 'require|max:32',       // 副标题
        'promotion_title' => 'require|max:128', // 促销语
        'keywords' => 'require',        // 关键词
...
//        'keywords.chsDash' => '关键字必须是汉字、字母、数字和下划线_及破折号',
    ...
    protected $scene = [
        ...
        'goods' => ['title', 'category_id', 'sub_title', 'promotion_title', 'keywords',
            'goods_unit', 'is_show_stock', 'stock', 'goods_specs_type',
